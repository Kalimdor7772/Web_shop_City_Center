...
export const formatProductWeight = (product) => {
    ...
    const grams = Number(product.servingGrams || product.nutrition?.servingGrams || 0);
    const basis = String(product.nutritionBasis || product.nutrition?.basis || "").toLowerCase();
